...
132 verbs cannot be compared at all, and another 298 disagree with ElixirFM somewhere in their paradigm. Every discrepancy falls into one of the categories below. Those marked *No* have been adjudicated against Wiktionary; those marked *Under investigation* are where Wiktionary sides with ElixirFM and are not yet resolved. Seven verbs disagree in two ways and are listed under both categories, so the rows do not sum to 298.
...
| <details><summary>**Second-radical hamza dropped.** Muṣarrif loses the hamza (أَنَى for نَأَى), where ElixirFM and Wiktionary keep it (أَنأَى).</summary>`S'y-1`, `n'y-1`</details> | 2 | Under investigation |
