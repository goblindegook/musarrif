...
Running the ElixirFM comparison across the full 4969-verb dataset (`npm run debug:elixirfm`) currently scores **~98.6% agreement**, excluding the conjugations ElixirFM has no equivalent for.

132 verbs cannot be compared at all, and another 307 disagree with ElixirFM somewhere in their paradigm. Every discrepancy falls into one of the categories below. Those marked *No* have been adjudicated against Wiktionary; those marked *Under investigation* are where Wiktionary sides with ElixirFM and are not yet resolved. Seven verbs disagree in two ways and are listed under both categories, so the rows do not sum to 307.
...
| <details><summary>**Hamza seat.** Carrier choice, not vocalisation: Muṣarrif writes بَائُوا, تَبُوءَانِ, أُوءَدُ and تَرْتَأِ where ElixirFM has بَاؤُوا, تَبُوؤَانِ, أُوؤَدُ and تَرتَإِ. Wiktionary and Reverso write the Muṣarrif spellings; where Wiktionary lists a variant (جَاؤُوا), it lists the Muṣarrif one first. The exception is the first-person jussive of `w'y-1` (أَأِ), which Wiktionary writes أَءِ or أَئِ.</summary>`Dw'-4`, `Dw'-10`, `bw'-1`, `fy'-4`, `jy'-1`, `n'y-8`, `nw'-1`, `nw'-4`, `r'y-3`, `r'y-6`, `r'y-8`, `sw'-4`, `sw'-8`, `w'd-1`, `w'y-1`, `y's-1`</details> | 16 | No, apart from the `w'y-1` jussive |
...
| <details><summary>**Initial wāw dropped from *i-a* assimilated Form I verbs.** Muṣarrif drops the wāw from the present and imperative (أَجَلُ and جَلْ for وَجِلَ), where ElixirFM keeps it (أَوجَلُ and اِوجَل). Wiktionary writes the present with the wāw and the imperative اِيجَلْ.</summary>`wHl-1`, `wbr-1`, `whl-1`, `whm-1`, `wjE-1`, `wjl-1`, `wlE-1`, `wsn-1`, `wsx-1`, `wxm-1`</details> | 10 | Under investigation |
...
| <details><summary>**Yāʾ-initial Form IV.** Muṣarrif keeps the yāʾ in the active present and the passive (أُيقِظُ and أُيقَظُ for أَيْقَظَ), where ElixirFM and Wiktionary write a wāw (أُوقِظُ and أُوقَظُ).</summary>`yqZ-4`, `yqn-4`, `ysr-4`, `ytm-4`</details> | 4 | Under investigation |
| <details><summary>**Form VII passive and Form X of verbs with a medial wāw and a weak final radical.** Muṣarrif conjugates them as hollow verbs (أَسْتَهِيي for اِسْتَهْوَى, يُنْضَايُ for اِنْضَوَى), where ElixirFM and Wiktionary keep the wāw (أَستَهوِي, يُنضَوَى).</summary>`Dwy-7`, `Twy-7`, `hwy-10`, `qwy-10`</details> | 4 | Under investigation |
| <details><summary>**Second-radical hamza dropped.** Muṣarrif loses the hamza (أَنَى for نَأَى, أُسِمُ for أَسْأَمَ), where ElixirFM and Wiktionary keep it (أَنأَى, أُسئِمُ).</summary>`S'y-1`, `n'y-1`, `s'm-4`</details> | 3 | Under investigation |
