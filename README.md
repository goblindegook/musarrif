...
Running the ElixirFM comparison across the full 992-verb dataset (`npm run debug:elixirfm`) currently scores **~98.4% agreement**, excluding the conjugations ElixirFM has no equivalent for.

89 verbs cannot be compared at all, and another 99 disagree with ElixirFM somewhere in their paradigm. Every discrepancy falls into one of the categories below, and each category has been adjudicated against Wiktionary. Four verbs disagree in two ways and are listed under both categories, so the rows do not sum to 99.

| Discrepancy | Verbs | Error? |
| --- | --- | --- |
| <details><summary>**Not in ElixirFM.** The lexeme is absent from ElixirFM's lexicon, so the whole paradigm is skipped.</summary>`$rb-7`, `$rb-10`, `'*y-2`, `'jr-3`, `'mm-1`, `'r$f-1`, `'tmt-1`, `'wl-5`, `'x*-7`, `'x*-10`, `*hb-5`, `*hb-6`, `*hb-10`, `*xr-2`, `DHk-2`, `Ely-1`, `Eml-2`, `Hr$f-3`, `Hrb-1`, `Hrfz-3`, `Hrjm-3`, `Hrk-1`, `Hsn-6`, `Hsn-7`, `Hsn-8`, `Hss-2`, `SbH-1`, `Sdr-6`, `Srf-3`, `Srf-10`, `Srx-4`, `Swr-1`, `TEm-6`, `Tbq-1`, `bHbH-1`, `brg$-4`, `drs-5`, `drs-10`, `dxl-2`, `fEl-2`, `fEl-4`, `fkr-1`, `fkr-6`, `jlEb-4`, `jlEd-4`, `jlfE-3`, `jrmz-4`, `klm-1`, `klm-6`, `ktb-2`, `ktb-5`, `kyf-2`, `mkn-1`, `mrD-10`, `qSS-7`, `qr'-2`, `qr'-3`, `qr'-5`, `qr'-7`, `qwd-2`, `qwd-3`, `qwd-5`, `qwd-6`, `qwl-2`, `qwl-5`, `r$f-4`, `rdd-3`, `rdd-6`, `rmy-2`, `rmy-7`, `rtb-1`, `tHd-1`, `tHr-1`, `tdr-1`, `tmr-1`, `tnb-1`, `wld-4`, `xrmS-4`, `zrq-2`</details> | 79 | No |
| <details><summary>**Doubled-verb contraction.** ElixirFM renders jussive and imperative of doubled verbs uncontracted (يَشدِد) where Muṣarrif contracts (يَشِدَّ). Both are attested; Muṣarrif prefers the contracted reading.</summary>`$bb-1`, `$dd-1`, `$ff-1`, `$ff-10`, `$kk-1`, `'dd-1`, `'jj-1`, `'mm-8`, `'zz-1`, `*mm-1`, `Ddd-6`, `Djj-1`, `Dll-1`, `Dmm-1`, `Drr-1`, `Drr-8`, `Edd-1`, `Edd-4`, `Edd-10`, `Enn-1`, `Hbb-1`, `Hbb-4`, `Hbb-6`, `Hbb-10`, `Hjj-8`, `Hll-8`, `Hmm-10`, `Hqq-10`, `Hss-1`, `Hss-4`, `Smm-1`, `Smm-4`, `Zll-1`, `Znn-1`, `bvv-7`, `dss-7`, `fkk-1`, `fkk-7`, `gll-10`, `hll-1`, `hmm-4`, `jbb-1`, `kff-7`, `lmm-1`, `mdd-1`, `mdd-3`, `mdd-4`, `mdd-8`, `mdd-10`, `mrr-1`, `mrr-10`, `mss-1`, `mss-6`, `qll-1`, `qrr-1`, `qrr-4`, `qrr-10`, `rdd-1`, `rdd-8`, `rdd-10`, `sbb-1`, `sbb-6`, `sff-4`, `srr-3`, `tmm-1`, `tmm-4`, `wdd-1`, `xTT-1`</details> | 68 | No |
| <details><summary>**Hamza seat.** Carrier choice, not vocalisation: Muṣarrif writes بَائُوا, تَبُوءَانِ, أُوءَدُ and تَرْتَأِ where ElixirFM has بَاؤُوا, تَبُوؤَانِ, أُوؤَدُ and تَرتَإِ. Wiktionary and Reverso write the Muṣarrif spellings; where Wiktionary lists a variant (جَاؤُوا), it lists the Muṣarrif one first.</summary>`Dw'-4`, `Dw'-10`, `bw'-1`, `jy'-1`, `nw'-1`, `r'y-3`, `r'y-6`, `r'y-8`, `sw'-8`, `w'd-1`, `w'y-1`</details> | 11 | No |
| <details><summary>**Form I citation vowel differs.** ElixirFM's Form I entry for the root is a different vowelling of the same verb — حَبَط for Muṣarrif's حَبِطَ, كَبَر for كَبُرَ — so the paradigm is skipped rather than compared.</summary>`$jE-1`, `HbT-1`, `bEd-1`, `g$y-1`, `gmD-1`, `kbr-1`, `qdm-1`, `wjz-1`, `wvq-1`, `xsr-1`</details> | 10 | No |
| <details><summary>**Form IX gemination.** The pattern geminates the final radical of a sound root, and ElixirFM again leaves the jussive and imperative uncontracted: يَحمَرِر where Muṣarrif contracts to يَحْمَرَّ.</summary>`Hmr-9`, `Sfr-9`, `byD-9`, `xDl-9`, `xDr-9`, `zrq-9`</details> | 6 | No |
| <details><summary>**Form I stem-vowel variants.** Muṣarrif reads أَحْسَبُ where ElixirFM reads أَحسِبُ, and مَسِسْتُ where it reads مَسَستُ. Both vowellings are lexically attested.</summary>`Hsb-1`, `Hss-1`, `Tbx-1`, `lms-1`, `mss-1`, `rkz-1`</details> | 6 | No |
| <details><summary>**Form I passive of assimilated verbs.** ElixirFM drops the stem wāw (يُعَى) where the passive retains it (يُوعَى).</summary>`w'y-1`, `wEy-1`, `wly-1`, `wny-1`, `wqy-1`</details> | 5 | No |
| <details><summary>**Prothetic imperative vowel on weak initials.** After the prothetic alif, Muṣarrif merges a vowelless weak first radical into the matching long vowel — اِيدَدْنَ for وَدَّ, اُوسُرْ for يَسُرَ — where ElixirFM keeps the radical (اِودَد, اُيسُر). Wiktionary and Reverso both write the merged forms.</summary>`wdd-1`, `ysr-1`</details> | 2 | No |
...
| <details><summary>**Defective imperfect vowel.** Same lexeme, different imperfect: ElixirFM inflects بَكَى (b k y) with an a~a imperfect — يَبكَى, تَبكَونَ — where Muṣarrif reads a~i: يَبْكِي, تَبْكُونَ. Wiktionary and Reverso both give the Muṣarrif vowelling, neither records an a~a variant, and Qutrub returns يَبْكِي even when asked for an a~a reading.</summary>`bky-1`</details> | 1 | No |
