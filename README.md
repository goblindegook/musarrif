...
| <details><summary>**Variant lexeme compared.** The citation form matches, but ElixirFM inflects a different verb: `bky-1` compares Muṣarrif's بَكَى يَبْكِي (to weep) against ElixirFM's يَبكَى, and `Swr-1` compares صَارَ يَصُورُ (ṣ w r, to give shape) against the homographic صَارَ يَصِيرُ (ṣ y r, to become).</summary>`Swr-1`, `bky-1`</details> | 2 | No |
