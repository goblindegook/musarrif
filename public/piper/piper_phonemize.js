var createPiperPhonemize = (() => {
  ...
  return (moduleArg = {}) => {
    ...
    var exceptionLast = 0
    var _uncaughtExceptionCount = 0
    var ___cxa_throw = (ptr, type, destructor) => {
      var info = new ExceptionInfo(ptr)
      info.init(type, destructor)
      exceptionLast = ptr
      _uncaughtExceptionCount++
      throw exceptionLast
    }
    var setErrNo = (value) => {
    ...
    var FS = {
      ...
      createDefaultDevices() {
        ...
        FS.registerDevice(FS.makedev(1, 3), {
          read: () => 0,
          write: (_stream, _buffer, _offset, length, _pos) => length,
        })
      ...
      createLazyFile(parent, name, url, canRead, canWrite) {
        ...
        if (typeof XMLHttpRequest !== 'undefined') {
          ...
          var _properties = { isDevice: false, contents: lazyArray }
        } else {
    ...
    function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
      ...
      try {
        if (Number.isNaN(offset)) return 61
        var stream = SYSCALLS.getStreamFromFD(fd)
    ...
    var _strftime_l = (s, maxsize, format, tm, _loc) => _strftime(s, maxsize, format, tm)
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = createPiperPhonemize
else if (typeof define === 'function' && define.amd) define([], () => createPiperPhonemize)
