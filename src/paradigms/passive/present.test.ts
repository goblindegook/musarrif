...
describe('passive present indicative', () => {
  ...
  describe('Form I', () => {
    ...
    describe('geminate roots', () => {
      ...
      test('أَمَّ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('ءمم', 1), 'indicative')).toEqualT({
          '1s': 'أُؤَمُّ',
          '2ms': 'تُؤَمُّ',
          '2fs': 'تُؤَمِّيْنَ',
          '3ms': 'يُؤَمُّ',
    ...
    describe('hamzated initial hollow roots', () => {
      test.each<[string, string]>([['ءول', 'يُؤَالُ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePresentMood(getVerb(root, 1), 'indicative')['3ms']).toEqualT(expected)
      })

      test('يُؤَالُ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('ءول', 1), 'indicative')).toEqualT({
          '1s': 'أُؤَالُ',
          '2ms': 'تُؤَالُ',
          '2fs': 'تُؤَالِيْنَ',
          '3ms': 'يُؤَالُ',
    ...
    describe('hamzated initial roots', () => {
      ...
      test('أَخَذَ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('ءخذ', 1), 'indicative')).toEqualT({
          '1s': 'أُوخَذُ',
          '2ms': 'تُؤْخَذُ',
          '2fs': 'تُؤْخَذِيْنَ',
          '3ms': 'يُؤْخَذُ',
    ...
    describe('hamzated initial doubly weak roots', () => {
      test('أَوَى conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('ءوي', 1), 'indicative')).toEqualT({
          '1s': 'أُووَى',
          '2ms': 'تُؤْوَى',
          '2fs': 'تُؤْوَيْنَ',
          '3ms': 'يُؤْوَى',
    ...
    describe('hamzated final roots', () => {
      ...
      test('كَلَأَ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('كلء', 1), 'indicative')).toEqualT({
          '1s': 'أُكْلَأُ',
          '2ms': 'تُكْلَأُ',
          '2fs': 'تُكْلَئِيْنَ',
          '3ms': 'يُكْلَأُ',
    ...
    describe('hamzated final-weak roots', () => {
      test('أَتَى conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('ءتي', 1), 'indicative')).toEqualT({
          '1s': 'أُوتَى',
          '2ms': 'تُؤْتَى',
          '2fs': 'تُؤْتَيْنَ',
          '3ms': 'يُؤْتَى',
  ...
  describe('Form II', () => {
    ...
    describe('hamzated final roots', () => {
      test.each([['هنء', 'يُهَنَّأُ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePresentMood(getVerb(root, 2), 'indicative')['3ms']).toEqualT(expected)
      })
    })
    ...
    describe('hollow roots', () => {
      ...
      test('أَوَّلَ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('ءول', 2), 'indicative')).toEqualT({
          '1s': 'أُؤَوَّلُ',
          '2ms': 'تُؤَوَّلُ',
          '2fs': 'تُؤَوَّلِيْنَ',
          '3ms': 'يُؤَوَّلُ',
  ...
  describe('Form III', () => {
    ...
    describe('hamzated middle roots', () => {
      test.each([['لءم', 'يُلَاءَمُ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePresentMood(getVerb(root, 3), 'indicative')['3ms']).toEqualT(expected)
      })

      test('وَاءَمَ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('وءم', 3), 'indicative')).toEqualT({
          '1s': 'أُوَاءَمُ',
          '2ms': 'تُوَاءَمُ',
          '2fs': 'تُوَاءَمِيْنَ',
          '3ms': 'يُوَاءَمُ',
    ...
    describe('hamzated final roots', () => {
      test.each([['فجء', 'يُفَاجَأُ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePresentMood(getVerb(root, 3), 'indicative')['3ms']).toEqualT(expected)
      })
    })
  ...
  describe('Form IV', () => {
    ...
    describe('defective roots', () => {
      ...
      test('أَمْسَى conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('مسو', 4), 'indicative')).toEqualT({
          '1s': 'أُمْسَى',
          '2ms': 'تُمْسَى',
          '2fs': 'تُمْسَيْنَ',
          '3ms': 'يُمْسَى',
      ...
      test('أُرِيَ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('رءي', 4), 'indicative')).toEqualT({
          '1s': 'أُرَى',
          '2ms': 'تُرَى',
          '2fs': 'تُرَيْنَ',
          '3ms': 'يُرَى',
    ...
    describe('hamzated final roots', () => {
      test.each([['نشء', 'يُنْشَأُ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePresentMood(getVerb(root, 4), 'indicative')['3ms']).toEqualT(expected)
      })

      test('أَوْمَأَ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('ومء', 4), 'indicative')).toEqualT({
          '1s': 'أُوْمَأُ',
          '2ms': 'تُوْمَأُ',
          '2fs': 'تُوْمَئِيْنَ',
          '3ms': 'يُوْمَأُ',
  ...
  describe('Form V', () => {
    ...
    describe('hamzated initial roots', () => {
      test.each([['ءول', 'يُتَأَوَّلُ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePresentMood(getVerb(root, 5), 'indicative')['3ms']).toEqualT(expected)
      })

      test('تَأَثَّرَ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('ءثر', 5), 'indicative')).toEqualT({
          '1s': 'أُتَأَثَّرُ',
          '2ms': 'تُتَأَثَّرُ',
          '2fs': 'تُتَأَثَّرِيْنَ',
          '3ms': 'يُتَأَثَّرُ',
  ...
  describe('Form VIII', () => {
    describe('regular roots', () => {
      ...
      test('اِذَّكَرَ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('ذكر', 8), 'indicative')).toEqualT({
          '1s': 'أُذَّكَرُ',
          '2ms': 'تُذَّكَرُ',
          '2fs': 'تُذَّكَرِيْنَ',
          '3ms': 'يُذَّكَرُ',
    ...
    describe('defective roots', () => {
      ...
      test('اُرْتُدِيَ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('ردي', 8), 'indicative')).toEqualT({
          '1s': 'أُرْتَدَى',
          '2ms': 'تُرْتَدَى',
          '2fs': 'تُرْتَدَيْنَ',
          '3ms': 'يُرْتَدَى',
      ...
      test('اُشْتُرِيَ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('شري', 8), 'indicative')).toEqualT({
          '1s': 'أُشْتَرَى',
          '2ms': 'تُشْتَرَى',
          '2fs': 'تُشْتَرَيْنَ',
          '3ms': 'يُشْتَرَى',
      ...
      test('اُخْتُفِيَ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('خفي', 8), 'indicative')).toEqualT({
          '1s': 'أُخْتَفَى',
          '2ms': 'تُخْتَفَى',
          '2fs': 'تُخْتَفَيْنَ',
          '3ms': 'يُخْتَفَى',
    ...
    describe('hamzated final roots', () => {
      ...
      test('اِبْتَدَأَ conjugation', () => {
        expect(conjugatePassivePresentMood(getVerb('بدء', 8), 'indicative')).toEqualT({
          '1s': 'أُبْتَدَأُ',
          '2ms': 'تُبْتَدَأُ',
          '2fs': 'تُبْتَدَئِيْنَ',
          '3ms': 'يُبْتَدَأُ',
  ...
  describe('Form X', () => {
    ...
    describe('hamzated initial roots', () => {
      test.each([['ءجر', 'يُسْتَأْجَرُ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePresentMood(getVerb(root, 10), 'indicative')['3ms']).toEqualT(expected)
      })
    })

    describe('hamzated final hollow roots', () => {
      test.each([['ضوء', 'يُسْتَضَاءُ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePresentMood(getVerb(root, 10), 'indicative')['3ms']).toEqualT(expected)
      })
    })
  })
  ...
  describe('Form IVq', () => {
    describe('regular roots', () => {
      ...
      test.each([['برغش', 'يُبْرَغَشُّ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePresentMood(getVerb(root, 4), 'indicative')['3ms']).toEqualT(expected)
      })

      test.each([['جلعب', 'يُجْلَعَبُّ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePresentMood(getVerb(root, 4), 'indicative')['3ms']).toEqualT(expected)
      })
    })
  })
