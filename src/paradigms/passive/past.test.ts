...
describe('passive past pattern', () => {
  ...
  describe('Form VII', () => {
    ...
    describe('geminate roots', () => {
      ...
      test('اِنْقَصَّ conjugation', () => {
        expect(conjugatePassivePast(getVerb('قصص', 7))).toEqualT({
          '1s': 'اُنْقُصِصْتُ',
          '2ms': 'اُنْقُصِصْتَ',
          '2fs': 'اُنْقُصِصْتِ',
          '3ms': 'اُنْقُصَّ',
  ...
  describe('Form IV', () => {
    describe('regular roots', () => {
      ...
      test('أَوْضَحَ conjugation', () => {
        expect(conjugatePassivePast(getVerb('وضح', 4))).toEqualT({
          '1s': 'أُوْضِحْتُ',
          '2ms': 'أُوْضِحْتَ',
          '2fs': 'أُوْضِحْتِ',
          '3ms': 'أُوْضِحَ',
    ...
    describe('hamzated initial defective roots', () => {
      test.each([['ءتي', 'أُوْتِيَ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePast(getVerb(root, 4))['3ms']).toEqualT(expected)
      })
  ...
  describe('Form X', () => {
    ...
    describe('defective roots', () => {
      test('اِسْتَأْنَى conjugation', () => {
        expect(conjugatePassivePast(getVerb('ءني', 10))).toEqualT({
          ...
          '3ms': 'اُسْتُؤْنِيَ',
          '3fs': 'اُسْتُؤْنِيَتْ',
          '2d': 'اُسْتُؤْنِيْتُمَا',
          '3md': 'اُسْتُؤْنِيَا',
          '3fd': 'اُسْتُؤْنِيَتَا',
          '1p': 'اُسْتُؤْنِيْنَا',
          '2mp': 'اُسْتُؤْنِيْتُمْ',
          '2fp': 'اُسْتُؤْنِيْتُنَّ',
          '3mp': 'اُسْتُؤْنُوْا',
          '3fp': 'اُسْتُؤْنِيْنَ',
        })
      })
      ...
      test('اِسْتَدْعَى conjugation', () => {
        expect(conjugatePassivePast(getVerb('دعو', 10))).toEqualT({
          ...
          '3ms': 'اُسْتُدْعِيَ',
          '3fs': 'اُسْتُدْعِيَتْ',
          '2d': 'اُسْتُدْعِيْتُمَا',
          '3md': 'اُسْتُدْعِيَا',
          '3fd': 'اُسْتُدْعِيَتَا',
          '1p': 'اُسْتُدْعِيْنَا',
          '2mp': 'اُسْتُدْعِيْتُمْ',
          '2fp': 'اُسْتُدْعِيْتُنَّ',
          '3mp': 'اُسْتُدْعُوْا',
          '3fp': 'اُسْتُدْعِيْنَ',
        })
      })
    ...
    describe('doubly weak roots', () => {
      test.each([['ولي', 'اُسْتُوْلِيَ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePast(getVerb(root, 10))['3ms']).toEqualT(expected)
      })
      ...
      test('اِسْتَحْيَا conjugation', () => {
        expect(conjugatePassivePast(getVerb('حيي', 10))).toEqualT({
          ...
          '3ms': 'اُسْتُحْيِيَ',
          '3fs': 'اُسْتُحْيِيَتْ',
          '2d': 'اُسْتُحْيِيْتُمَا',
          '3md': 'اُسْتُحْيِيَا',
          '3fd': 'اُسْتُحْيِيَتَا',
          '1p': 'اُسْتُحْيِيْنَا',
          '2mp': 'اُسْتُحْيِيْتُمْ',
          '2fp': 'اُسْتُحْيِيْتُنَّ',
          '3mp': 'اُسْتُحْيُوْا',
          '3fp': 'اُسْتُحْيِيْنَ',
        })
      })
    ...
    describe('hamzated final hollow roots', () => {
      test.each([['ضوء', 'اُسْتُضِيءَ']])('%s pattern', (root, expected) => {
        expect(conjugatePassivePast(getVerb(root, 10))['3ms']).toEqualT(expected)
      })
    })
  })
