      ...
      steps: [
        ...
        },
        {
          ...
          morphemes: [
            ...
            { text: 'حِبُ', role: 'radical' },
            { text: 'ّ', role: 'agreement' },
          ],
        },
        {
          kind: { type: 'tense', verbTense: 'active.present.jussive' },
