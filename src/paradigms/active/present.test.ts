    ...
    describe('regular roots', () => {
      ...
      test('تَعَرْقَلَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('عرقل', 2), 'indicative')).toEqualT({
          ...
          '3fd': 'تَتَعَرْقَلَانِ',
          '1p': 'نَتَعَرْقَلُ',
          '2mp': 'تَتَعَرْقَلُوْنَ',
          '2fp': 'تَتَعَرْقَلْنَ',
          '3mp': 'يَتَعَرْقَلُوْنَ',
          '3fp': 'يَتَعَرْقَلْنَ',
        })
      })
    })
    ...
    describe('hamzated initial roots', () => {
      ...
      test('تَأَمْرَكَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('ءمرك', 2), 'indicative')).toEqualT({
          ...
          '3fd': 'تَتَأَمْرَكَانِ',
          '1p': 'نَتَأَمْرَكُ',
          '2mp': 'تَتَأَمْرَكُوْنَ',
          '2fp': 'تَتَأَمْرَكْنَ',
          '3mp': 'يَتَأَمْرَكُوْنَ',
          '3fp': 'يَتَأَمْرَكْنَ',
        })
      })
    })
    ...
    describe('regular roots', () => {
      ...
      test('اِجْلَنْفَعَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('جلفع', 3), 'indicative')).toEqualT({
          ...
          '3fd': 'تَجْلَنْفِعَانِ',
          '1p': 'نَجْلَنْفِعُ',
          '2mp': 'تَجْلَنْفِعُوْنَ',
          '2fp': 'تَجْلَنْفِعْنَ',
          '3mp': 'يَجْلَنْفِعُوْنَ',
          '3fp': 'يَجْلَنْفِعْنَ',
        })
      })
    })
