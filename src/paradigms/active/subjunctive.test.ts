...
describe('active present subjunctive', () => {
  describe('Form I', () => {
    ...
    describe('geminate roots', () => {
      ...
      test('أَمَّ conjugation', () => {
        expect(conjugatePresentMood(getVerb('ءمم', 1), 'subjunctive')).toEqualT({
          '1s': 'أَؤُمَّ',
          '2ms': 'تَؤُمَّ',
          '2fs': 'تَؤُمِّي',
          '3ms': 'يَؤُمَّ',
    ...
    describe('hamzated final roots', () => {
      ...
      test('قَرَأَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('قرء', 1), 'subjunctive')).toEqualT({
          '1s': 'أَقْرَأَ',
          '2ms': 'تَقْرَأَ',
          '2fs': 'تَقْرَئِي',
          '3ms': 'يَقْرَأَ',
      ...
      test('كَلَأَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('كلء', 1), 'subjunctive')).toEqualT({
          '1s': 'أَكْلُؤَ',
          '2ms': 'تَكْلُؤَ',
          '2fs': 'تَكْلُئِي',
          '3ms': 'يَكْلُؤَ',
    ...
    describe('hamzated initial defective roots', () => {
      ...
      test('أَبَى conjugation', () => {
        expect(conjugatePresentMood(getVerb('ءبي', 1), 'subjunctive')).toEqualT({
          '1s': 'آبَى',
          '2ms': 'تَأْبَى',
          '2fs': 'تَأْبَيْ',
          '3ms': 'يَأْبَى',
      ...
      test('أَتَى conjugation', () => {
        expect(conjugatePresentMood(getVerb('ءتي', 1), 'subjunctive')).toEqualT({
          '1s': 'آتِيَ',
          '2ms': 'تَأْتِيَ',
          '2fs': 'تَأْتِي',
          '3ms': 'يَأْتِيَ',
    ...
    describe('hamzated final hollow roots', () => {
      test.each([['نوء', 'يَنُوءَ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 1), 'subjunctive')['3ms']).toEqualT(expected)
      })
    ...
    describe('hamzated initial hollow roots', () => {
      test.each([['ءول', 'يَؤُولَ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 1), 'subjunctive')['3ms']).toEqualT(expected)
      })

      test('يَؤُولَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('ءول', 1), 'subjunctive')).toEqualT({
          '1s': 'أَؤُولَ',
          '2ms': 'تَؤُولَ',
          '2fs': 'تَؤُولِي',
          '3ms': 'يَؤُولَ',
    ...
    describe('hamzated hollow-defective roots', () => {
      test.each([['ءوي', 'يَأْوِيَ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 1), 'subjunctive')['3ms']).toEqualT(expected)
      })

      test('أَوَى conjugation', () => {
        expect(conjugatePresentMood(getVerb('ءوي', 1), 'subjunctive')).toEqualT({
          '1s': 'آوِيَ',
          '2ms': 'تَأْوِيَ',
          '2fs': 'تَأْوِي',
          '3ms': 'يَأْوِيَ',
  ...
  describe('Form II', () => {
    ...
    describe('hamzated final roots', () => {
      test.each([['هنء', 'يُهَنِّئَ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 2), 'subjunctive')['3ms']).toEqualT(expected)
      })
    })
    ...
    describe('hamzated initial hollow roots', () => {
      test('أَيَّدَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('ءيد', 2), 'subjunctive')).toEqualT({
          '1s': 'أُؤَيِّدَ',
          '2ms': 'تُؤَيِّدَ',
          '2fs': 'تُؤَيِّدِي',
          '3ms': 'يُؤَيِّدَ',
  ...
  describe('Form III', () => {
    ...
    describe('hamzated initial roots', () => {
      ...
      test('آخَذَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('ءخذ', 3), 'subjunctive')).toEqualT({
          '1s': 'أُؤَاخِذَ',
          '2ms': 'تُؤَاخِذَ',
          '2fs': 'تُؤَاخِذِي',
          '3ms': 'يُؤَاخِذَ',
      ...
      test('آجَرَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('ءجر', 3), 'subjunctive')).toEqualT({
          '1s': 'أُؤَاجِرَ',
          '2ms': 'تُؤَاجِرَ',
          '2fs': 'تُؤَاجِرِي',
          '3ms': 'يُؤَاجِرَ',
    ...
    describe('hamzated middle roots', () => {
      test.each([['وءم', 'يُوَائِمَ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 3), 'subjunctive')['3ms']).toEqualT(expected)
      })
    })

    describe('hamzated final roots', () => {
      test.each([['فجء', 'يُفَاجِئَ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 3), 'subjunctive')['3ms']).toEqualT(expected)
      })

      test('فَاجَأَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('فجء', 3), 'subjunctive')).toEqualT({
          '1s': 'أُفَاجِئَ',
          '2ms': 'تُفَاجِئَ',
          '2fs': 'تُفَاجِئِي',
          '3ms': 'يُفَاجِئَ',
  ...
  describe('Form V', () => {
    describe('geminate roots', () => {
      test.each([['مدد', 'يَتَمَدَّدَ']])('%s pattern', (root, expected) => {
    ...
    describe('hamzated initial geminate roots', () => {
      test.each([['ءمم', 'يَتَأَمَّمَ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 5), 'subjunctive')['3ms']).toEqualT(expected)
      })
    })
  ...
  describe('Form VIII', () => {
    ...
    describe('defective roots', () => {
      test.each([['صفو', 'يَصْطَفِيَ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 8), 'subjunctive')['3ms']).toEqualT(expected)
      })
    })
    ...
    describe('assimilated roots', () => {
      ...
      test('اِتَّكَأَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('وكء', 8), 'subjunctive')).toEqualT({
          '1s': 'أَتَّكِئَ',
          '2ms': 'تَتَّكِئَ',
          '2fs': 'تَتَّكِئِي',
          '3ms': 'يَتَّكِئَ',
    ...
    describe('hamzated initial geminate roots', () => {
      test('يَأْتَمَّ conjugation', () => {
        expect(conjugatePresentMood(getVerb('ءمم', 8), 'subjunctive')).toEqualT({
          '1s': 'آتَمَّ',
          '2ms': 'تَأْتَمَّ',
          '2fs': 'تَأْتَمِّي',
          '3ms': 'يَأْتَمَّ',
  ...
  describe('Form VI', () => {
    ...
    describe('hamzated final roots', () => {
      test.each([['بطء', 'يَتَبَاطَأَ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 6), 'subjunctive')['3ms']).toEqualT(expected)
      })
    })
  ...
  describe('Form VII', () => {
    ...
    describe('hamzated final roots', () => {
      test('اِنْقَرَأَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('قرء', 7), 'subjunctive')).toEqualT({
          '1s': 'أَنْقَرِئَ',
          '2ms': 'تَنْقَرِئَ',
          '2fs': 'تَنْقَرِئِي',
          '3ms': 'يَنْقَرِئَ',
  ...
  describe('Form X', () => {
    ...
    describe('doubly weak roots', () => {
      test('اِسْتَحْيَا conjugation', () => {
        expect(conjugatePresentMood(getVerb('حيي', 10), 'subjunctive')).toEqualT({
          '1s': 'أَسْتَحْيِيَ',
          '2ms': 'تَسْتَحْيِيَ',
          '2fs': 'تَسْتَحْيِي',
          '3ms': 'يَسْتَحْيِيَ',
    ...
    describe('hamzated initial roots', () => {
      test.each([['ءجر', 'يَسْتَأْجِرَ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 10), 'subjunctive')['3ms']).toEqualT(expected)
      })
    })
    ...
    describe('hamzated final roots', () => {
      test('اِسْتَقْرَأَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('قرء', 10), 'subjunctive')).toEqualT({
          '1s': 'أَسْتَقْرِئَ',
          '2ms': 'تَسْتَقْرِئَ',
          '2fs': 'تَسْتَقْرِئِي',
          '3ms': 'يَسْتَقْرِئَ',
    ...
    describe('hamzated final hollow roots', () => {
      test('اِسْتَضَاءَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('ضوء', 10), 'subjunctive')).toEqualT({
          '1s': 'أَسْتَضِيءَ',
          '2ms': 'تَسْتَضِيءَ',
          '2fs': 'تَسْتَضِيئِي',
          '3ms': 'يَسْتَضِيءَ',
  ...
  describe('Form IIq', () => {
    describe('regular roots', () => {
      ...
      test('تَعَرْقَلَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('عرقل', 2), 'subjunctive')).toEqualT({
          '1s': 'أَتَعَرْقَلَ',
          '2ms': 'تَتَعَرْقَلَ',
          '2fs': 'تَتَعَرْقَلِي',
          '3ms': 'يَتَعَرْقَلَ',
    ...
    describe('hamzated initial roots', () => {
      test.each([['ءلمن', 'يَتَأَلْمَنَ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 2), 'subjunctive')['3ms']).toEqualT(expected)
      })

      test('تَأَمْرَكَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('ءمرك', 2), 'subjunctive')).toEqualT({
          '1s': 'أَتَأَمْرَكَ',
          '2ms': 'تَتَأَمْرَكَ',
          '2fs': 'تَتَأَمْرَكِي',
          '3ms': 'يَتَأَمْرَكَ',
  ...
  describe('Form IIIq', () => {
    describe('regular roots', () => {
      ...
      test('اِجْلَنْفَعَ conjugation', () => {
        expect(conjugatePresentMood(getVerb('جلفع', 3), 'subjunctive')).toEqualT({
          '1s': 'أَجْلَنْفِعَ',
          '2ms': 'تَجْلَنْفِعَ',
          '2fs': 'تَجْلَنْفِعِي',
          '3ms': 'يَجْلَنْفِعَ',
  ...
  describe('Form IVq', () => {
    describe('regular roots', () => {
      test('اِقْشَعَرَّ conjugation', () => {
        expect(conjugatePresentMood(getVerb('قشعر', 4), 'subjunctive')).toEqualT({
          '1s': 'أَقْشَعِرَّ',
          '2ms': 'تَقْشَعِرَّ',
          '2fs': 'تَقْشَعِرِّي',
          '3ms': 'يَقْشَعِرَّ',
      ...
      test('يَشْمَئِزَّ conjugation', () => {
        expect(conjugatePresentMood(getVerb('شمءز', 4), 'subjunctive')).toEqualT({
          '1s': 'أَشْمَئِزَّ',
          '2ms': 'تَشْمَئِزَّ',
          '2fs': 'تَشْمَئِزِّي',
          '3ms': 'يَشْمَئِزَّ',
      ...
      test.each([['برغش', 'يَبْرَغِشَّ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 4), 'subjunctive')['3ms']).toEqualT(expected)
      })

      test.each([['جرمز', 'يَجْرَمِزَّ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 4), 'subjunctive')['3ms']).toEqualT(expected)
      })

      test.each([['جلعب', 'يَجْلَعِبَّ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 4), 'subjunctive')['3ms']).toEqualT(expected)
      })

      test.each([['جلعد', 'يَجْلَعِدَّ']])('%s pattern', (root, expected) => {
        expect(conjugatePresentMood(getVerb(root, 4), 'subjunctive')['3ms']).toEqualT(expected)
      })
    })
  })
